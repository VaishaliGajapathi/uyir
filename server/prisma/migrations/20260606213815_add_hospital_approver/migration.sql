...
INSERT INTO "new_User" ("age", "banned", "bloodGroup", "createdAt", "district", "dob", "donationCount", "drinkingHabits", "fcmToken", "gender", "healthTips", "hemoglobinLevel", "id", "isPlateletDonor", "language", "lastDonationDate", "lat", "lng", "mobile", "name", "nightEmergency", "reputationScore", "role", "shareLocation", "sleepHours", "smokingHabits", "taluk", "verified") SELECT "age", "banned", "bloodGroup", "createdAt", "district", "dob", "donationCount", "drinkingHabits", "fcmToken", "gender", "healthTips", "hemoglobinLevel", "id", "isPlateletDonor", "language", "lastDonationDate", "lat", "lng", "mobile", "name", "nightEmergency", "reputationScore", "role", "shareLocation", "sleepHours", "smokingHabits", "taluk", "verified" FROM "User";
DROP TABLE "User";
